"""Fetch, validate and load newly finished games into lineup storage."""
...
def update(
    ...
    *,
    ...
    pending = [(season, game_id) for season, game_id in games if game_id not in stored]
    ...
    result = {"fetched": counts, "built": built, "loaded": loaded}
