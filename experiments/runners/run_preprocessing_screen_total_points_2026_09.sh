#!/usr/bin/env bash
# Six sequential fixed-hyperparameter CUDA cells for total-points preprocessing.
set -uo pipefail

cd "$(dirname "$0")/../.." || exit 1

CAMPAIGN="preprocessing_screen_total_points_2026_09"
...
log "Total-points preprocessing screen started $(date)"
