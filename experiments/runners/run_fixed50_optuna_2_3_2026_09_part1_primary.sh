#!/usr/bin/env bash
# Part 1: the three primary closing-line schema-2.3 Optuna experiments.
set -uo pipefail
...
CONFIGS=(
  "$CONFIG_DIR/a_closing_spread_2_3.yaml"
  "$CONFIG_DIR/b_closing_total_points_2_3.yaml"
  "$CONFIG_DIR/c_closing_line_error_2_3.yaml"
)
...
log "Three sequential CUDA runs; 150 trials each; seed 16."
log "CV: latest 12 anchors, 50 games per fold, 60-game step. Holdout: daily, 90 days."
log "Intermediate-line experiments are intentionally excluded."
log "Logs: $LOG_DIR"
