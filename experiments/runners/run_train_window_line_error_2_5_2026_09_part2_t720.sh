#!/usr/bin/env bash
# Schema-2.5 training-window sweep for line error at T-720: does older data help?
#
# Six cells. Five fix train_games at 1,500 / 2,500 / 3,500 / 4,500 / 5,675 on one
...
CONFIGS=(
  "$CONFIG_DIR/w_t720_g3500.yaml"
  "$CONFIG_DIR/w_t720_g3500_rep.yaml"
  "$CONFIG_DIR/w_t720_g1500.yaml"
  "$CONFIG_DIR/w_t720_g2500.yaml"
  "$CONFIG_DIR/w_t720_g4500.yaml"
  "$CONFIG_DIR/w_t720_g5675.yaml"
)
...
# DELIBERATELY UNLOCKED, like part 1. Neither part takes a lock, so the two run
...
# is possible rather than certain. See part 1 for how to serialise them instead.
