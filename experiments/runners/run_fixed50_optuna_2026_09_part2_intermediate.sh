#!/usr/bin/env bash
# Part 2: three T-360 fixed-50 Optuna experiments, sequential on one GPU.
set -uo pipefail

cd "$(dirname "$0")/../.." || exit 1

CAMPAIGN="fixed50_optuna_2026_09"
PART="part2_intermediate"
...
log "Three sequential CUDA runs; 150 complete-budget trials each; seed 16."
log "Data: intermediate 2.2 at T-360 minutes."
