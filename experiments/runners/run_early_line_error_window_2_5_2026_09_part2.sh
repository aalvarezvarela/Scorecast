#!/usr/bin/env bash
# Schema-2.5 early line-error windows, part2. Run both parts concurrently.
...
CONFIGS=(
  "$CONFIG_DIR/l_t30_line_error.yaml"
  "$CONFIG_DIR/l_t120_line_error.yaml"
  "$CONFIG_DIR/l_t240_line_error.yaml"
  "$CONFIG_DIR/l_t360_line_error_decay.yaml"
  "$CONFIG_DIR/l_t660_line_error.yaml"
  "$CONFIG_DIR/l_t720_line_error.yaml"
  "$CONFIG_DIR/l_t840_line_error.yaml"
  "$CONFIG_DIR/l_t960_line_error.yaml"
  "$CONFIG_DIR/l_t1080_line_error.yaml"
)
