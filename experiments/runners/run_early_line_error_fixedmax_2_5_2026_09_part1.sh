...
# horizon's maximum, with and without tuned time decay. part1.
...
CONFIGS=(
  "$CONFIG_DIR/l_t600_line_error_fixedmax.yaml"
  "$CONFIG_DIR/l_t600_line_error_fixedmax_decay.yaml"
  "$CONFIG_DIR/l_t360_line_error_fixedmax.yaml"
  "$CONFIG_DIR/l_t360_line_error_fixedmax_decay.yaml"
  "$CONFIG_DIR/l_t1080_line_error_fixedmax.yaml"
  "$CONFIG_DIR/l_t1080_line_error_fixedmax_decay.yaml"
)
