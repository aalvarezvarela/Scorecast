#!/usr/bin/env bash
# Schema-2.5 closing spread error, protocols a -> b -> c.
set -uo pipefail
...
CONFIGS=(
  "$CONFIG_DIR/s_a_spread_12x50_early_stop.yaml"
  "$CONFIG_DIR/s_b_spread_6x100_early_stop.yaml"
  "$CONFIG_DIR/s_c_spread_6x100_tuned_rounds.yaml"
)
